"""The mu (cosine of viewing angle) axis used by the stock icarus atmo/ grids
(e.g. ATLAS9.AB.Bessell.J.h5): 91 angles, finely sampled near the limb (0.01-0.40
in 0.005 steps) and coarsely toward disc centre (0.40-1.00 in 0.05 steps).

Set `MU = MU_ICARUS` in a config to put the photometry grid on this axis.
"""
